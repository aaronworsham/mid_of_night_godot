...
var second_member_guid:String
var second_member_name:String
var second_submember_guid:String
var second_submember_name:String
...
func base_setup():
	...
	second_member_guid = data_system_resource._member_array[1]["guid"]
	second_member_name = data_system_resource._member_array[1]["name"]
	second_submember_guid = data_system_resource._submember_array[1]["guid"]
	second_submember_name = data_system_resource._submember_array[1]["name"]
